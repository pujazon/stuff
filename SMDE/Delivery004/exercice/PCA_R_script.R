...
?readXL
food <- readXL("food.xls", rownames=TRUE, header=TRUE, na=" ", sheet="Sayfa1", stringsAsFactors=FALSE)
...
# Milwaukee is the cheapest State according to the prices of other aliments.
...
sort(apply(pca_cov$scores[,1:2],1,sum),decreasing=TRUE)[1:3]
...
domes <- readXL("domes.xls",rownames=FALSE, header=TRUE, na="", sheet="Sayfa1", 
