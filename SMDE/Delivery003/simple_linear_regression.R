...
cor.test(decathlon[,6],decathlon[,1])
...
# MSE=0.217, ths value is smaller than average of the response. 
...
# Here the confidence intervals of the parameters does not include 0.
